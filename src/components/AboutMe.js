...
const AboutMe = () => {
    return ( 
        <div className='row'>
            <div className='aboutme-container col-md-12'>
                <h1>ABOUT ME</h1>
                <hr />
                    <div>
                        ...
                        utilisateurs sur Symfony. Je suis aussi conscient de l’importance des tests pour garantir la robustesse d’une application. J'ai un bon niveau d'anglais et j'aime apprendre au quotidien sur différents
