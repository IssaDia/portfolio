    ...
    return ( 
        ...
        <div className='row'>
            <div className='col-md-8 text-center'>
                <p> Développeur Web Fullstack en reconversion qui aimerais participer à des projets ambitieux. Je me suis spécialisé dans React et Symfony aprés ma formation de Développeur et 
